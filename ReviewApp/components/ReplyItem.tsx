...
const ReplyItem: FC<Props> = ({ reply, depth = 1, id_review, getReviewComments }) => {
            ...
            <View style={styles.replyTextContainer}>
                ...
                {reply.replies?.length > 0 &&
                    reply.replies.map((child) => (
                        <ExpandableBox setButtonState={setButtonOpen} key={child.id_comment} buttonState={buttonOpen}>
                            <ReplyItem
                                reply={child}
                                depth={depth + 1}
                                id_review={id_review}
